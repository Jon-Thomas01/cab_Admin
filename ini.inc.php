...
if(strstr($_SERVER['REQUEST_URI'],"ads/index") ||  strstr($_SERVER['REQUEST_URI'],"room/room") || strstr($_SERVER['REQUEST_URI'],"users/index")) {
//die("ta");
}else{
...
//echo $GLOBALS[CC_SESSION_NAME]; die("TA");
?>