...
<?php
$html='
<table style=" margin:0px auto; padding:10px;"  border="0"  width="500" >
...
<table width="200" border="0">
  ...
  <tr>
	...
	$html .='<tr align="center">
	 ...
	 $html .='<tr>
<td colspan="2" style="width:300px; max-height:auto; min-height:30px; color:#fff; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:center; padding-top:5px; float:left; background-color:#38393f;">&copy; 2015-icabit.com. All rights reserved.</td>
</tr>
          </table>
