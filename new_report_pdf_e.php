 ...
 <table width="510" border="1" >
		...
		$record = $db->select($qury); 
            ...
            <td>'.$serial2.'</td>
                ...
                <td>&pound;&nbsp;'.$record[$k]['ordertotal'].'</td>
                <td>&pound;&nbsp;'.$record[$k]['new_price'].'</td>
                <td ><div>&pound;&nbsp;'.$diffrence.'</td>
                <td>&pound;&nbsp;'.$fixed_panility_charges.'</td>
                <td>&pound;&nbsp;'.$sum.'</td>
            ...
            $html .='<tr>
            <td height="50" align="right" colspan="8"><div style="padding-left:100px">&nbsp;<strong>Total Amount:&nbsp;&nbsp; &pound;&nbsp;'.$TOTAL.'</strong>&nbsp;</div></td>
...
$html.='  <tr style="height:60px; padding-left:10px; background-color:#E5E5E5;font-family:Arial, Helvetica, sans-serif; font-size:13px;">
    ...
    <td align="center">&pound; '. round($COMMISSION).'</td>
  </tr>';
  
$html.='  <tr style="height:60px; padding-left:10px; font-family:Arial, Helvetica, sans-serif; font-size:13px;">
    <td>&nbsp;&nbsp;Fixed panelty charges receievable<br />&nbsp;&nbsp;(No. of jobs X Rate)</td>
    <td align="center">&pound; '. round($FIXED_PANELTY) .'</td>
  </tr>';
$html.='  <tr style="height:60px; padding-left:10px; background-color:#E5E5E5;font-family:Arial, Helvetica, sans-serif; font-size:13px;">
    <td>&nbsp;&nbsp;Booking switch cost<br />&nbsp;&nbsp;(Revised fare-Booking fair)</td>
    <td align="center">&nbsp;&pound; '. round($BOOKING_SWITCH_COST).'</td>
  </tr>';
$html.='  <tr style="height:60px; padding-left:10px; font-family:Arial, Helvetica, sans-serif; font-size:13px;">
