...
var citymap = {<?php echo $str;?>};
 ...
 function calculateAndDisplayRoute(directionsService, directionsDisplay) {
	...
	//alert('origne=='+ window.opener.document.getElementById('origen').value);
	//alert('destination=='+ window.opener.document.getElementById('destination').value);
	
	directionsService.route({
	origin: window.opener.document.getElementById('origen').value,
    destination:window.opener.document.getElementById('destination').value,
